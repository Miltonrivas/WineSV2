        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            if (txtcuenta.Text != "")
            {
                try
                {
                    ...
                    MySqlConnection conexion = new MySqlConnection("Server=127.0.0.1; database=qr-project; Uid=root; pwd=;");
                    var cmd = "Select Password from usuarios where correo ='" + user + "';";
                    var cmd1 =  "Select correo from usuarios where correo ='" + user + "';";
                    var cmd2 =  "Select nombre from usuarios where correo ='" + user + "';";
                    ...
                    var fromAddress = new MailAddress("winesv22@gmail.com", "WineSV");
                    const string fromPassword = "yknfhuurksvgrvni";
